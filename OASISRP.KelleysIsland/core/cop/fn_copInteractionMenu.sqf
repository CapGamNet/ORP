...
if (!dialog) then {
    createDialog "cop_int";
};

_display = findDisplay 2201;
...
_Btn9 ctrlSetText "Sit Suspect";
_Btn9 buttonSetAction "[player] remoteExecCall [""life_fnc_copSit"",life_pInact_curTarget]; closeDialog 0;";

_Btn10 ctrlSetText "Stand Suspect";
_Btn10 buttonSetAction "[player] remoteExecCall [""life_fnc_copStand"",life_pInact_curTarget]; closeDialog 0;";
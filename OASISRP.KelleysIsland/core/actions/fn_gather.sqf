private ["_zone","_requiredItem","_exit","_resourceCfg","_curConfig","_resource","_maxGather","_zoneSize","_resourceZones","_valItem","_amount","_diff","_itemName"];
#include "..\..\script_macros.hpp"

//Exit Checks before we start the script.

...
if (_action) then {
    ...
    _house setVariable ["can_buy",false,true];
...
["Cant Sell House","You cant sell this house, please go to the market to sell it",[1,1,0,1]] call Lega_fnc_addNotification;